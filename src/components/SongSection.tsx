  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        {/* Album Art */}
        <div className="w-64 h-64 mx-auto mb-8 bg-gradient-to-br from-pink-girly/20 to-purple-girly/20 rounded-3xl flex items-center justify-center border border-white/10">
          <Music className="w-24 h-24 text-pink-girly" />
        </div>
