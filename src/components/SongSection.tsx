...
const SongSection = ({
  ...
  return <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="flex items-center mb-8">
        <button onClick={onBack} className="flex items-center gap-2 text-pink-girly hover:text-white transition-colors duration-300">
        ...
        preload="metadata" />
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input type="range" min="0" max="100" value={progressPercentage} onChange={handleSeek} className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer" style={{
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <button onClick={togglePlay} className="w-14 h-14 bg-gradient-to-r from-pink-girly to-purple-girly rounded-full flex items-center justify-center text-white hover:scale-105 transition-transform duration-300">
          ...
          <div className="flex items-center gap-3">
            <button onClick={toggleMute} className="text-pink-girly hover:text-white transition-colors duration-300">
              {isMuted ? <VolumeX className="w-5 h-5" /> : <Volume2 className="w-5 h-5" />}
            </button>
            <input type="range" min="0" max="100" value={isMuted ? 0 : volume * 100} onChange={handleVolumeChange} className="flex-1 h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer" style={{
